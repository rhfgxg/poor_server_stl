...
echo ""
print_info "下一步:"
echo "  1. 启动 Skynet: bash $PROJECT_ROOT/tools/service/start_skynet.sh"
echo "  2. 测试连接: bash $PROJECT_ROOT/tools/service/test_connection.sh"
echo ""
